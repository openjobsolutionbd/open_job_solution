...
| `archive/*.md` | মাসিক আসল সোর্স (রেফারেন্স, edit না; নতুন সেশন নিজের `archive/<YYYY-MM>-<স্কোপ>.md` ফাইল বানায়) |
...
5. কনফার্মেশনের পর **সরাসরি** সঠিক গন্তব্যে বসান — কোনো intermediate staging ফাইল ছাড়াই:
   ...
   - `docs/ghotonaprobaho/*.md` — তারিখ-ভিত্তিক দৈনিক ঘটনা (প্রতি সেশন নিজের **নতুন** ফাইল বানায়: `<YYYY-MM>-<স্কোপ>.md`; বিদ্যমান ফাইল সম্পাদনা/rename করবেন না — build একই তারিখের এন্ট্রি নিজে জোড়া লাগায়)
