...
3. **একই তারিখ অন্য সেশনের ফাইলে থাকলেও সমস্যা নেই** — build জোড়া লাগায়। হুবহু একই বুলেট দুই ফাইলে থাকলে একটা রাখে (stderr-এ সতর্কতা দেয়), তবু লেখার আগে তারিখ grep করে ডুপ্লিকেট-চেক করুন।
