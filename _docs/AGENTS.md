...
## ডেটার একক কেন্দ্রীয় উৎস (Single Source of Truth)

**`written-exam/data/job-solution.js` — লিখিত পরীক্ষার প্রশ্ন-উত্তর ডেটার একমাত্র কেন্দ্রীয় জায়গা।** নতুন কোনো এক্সামের প্রশ্ন-উত্তর processing/staging শেষ হলে চূড়ান্তভাবে এই ফাইলেই যোগ করতে হবে — অন্য কোনো ডেটা ফাইল, JSON, বা আলাদা মডিউল তৈরি করে ডেটা ছড়িয়ে রাখা যাবে না। `written-exam/exam-archive.js` শুধু প্রতিটা এক্সামের মেটাডেটা (ministry, post, date, marks, totalQuestions) রাখে এবং `job-solution.js`-এর সাথে `examId` দিয়ে সংযুক্ত থাকে — এটাও কেন্দ্রীয় কাঠামোর অংশ, `job-solution.js` থেকে বিচ্ছিন্নভাবে আপডেট করা উচিত না। যেকোনো নতুন টুল, স্ক্রিপ্ট, বা ফ্রন্টএন্ড ফিচার এই দুটো ফাইলকে কেন্দ্র করেই ডিজাইন করতে হবে।
