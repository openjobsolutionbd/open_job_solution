...
| `_staging/books-staging/` | "বই সমূহ" ফিচারের পরিকল্পনা/ডিজাইন-নোট (README + BOOKS_NOTES.md) — ২০২৬-০৮-৩০ তারিখে `bcs-mcq-staging/` মুছে ফেলা হয়েছে কারণ এর সব ৮৯ পাতার কনটেন্ট ইতিমধ্যে `bcs-mcq/data/*.js`-এ সম্পূর্ণভাবে verified হয়ে গেছে (৪ জোড়া near-duplicate ছাড়া প্রতিটা প্রশ্ন options+correctIndex সহ হুবহু মিলেছে) |
