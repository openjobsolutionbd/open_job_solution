...
2. 🔲 **Automated regression test suite (ojs-এ)** — oca-এর `scripts/js_tests/` প্যাটার্নে ojs-এর মূল অ্যাপের (bcs-mcq/primary-mcq/written-exam) জন্য jsdom-ভিত্তিক টেস্ট ইনফ্রাস্ট্রাকচার + npm script + CI workflow। এখনো শুরু হয়নি।
3. 🔲 **Spellcheck/docs-consistency script (oca-তে)** — ojs-এর `check-spelling.js`/`check_docs_consistency.js` প্যাটার্ন oca-এর কনটেন্ট (topics/ghotonaprobaho/top-news) যাচাইয়ে আনা। এখনো শুরু হয়নি।
